...
namespace DStarLite
{
	class Planner
	{
		public:
			 ...
			 * Key compare struct.
			 */
			// wyl: binary_function is just a base class, from which specific binary function objects are derived.
		...
		protected:			
			...
			typedef unordered_map<Map::Cell*, pair<double, double>, Map::Cell::Hash> CH;
			CH _cell_hash;
			...
			// wyl: Multimaps are associative containers that store elements formed by a combination of a key 
			// value and a mapped value, following a specific order, and where multiple elements can have equivalent keys.
			 ...
			 */
			// wyl: OL::iterator把open list和open hash关联到一起
